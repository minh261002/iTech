<footer class="mt-5">
    <div class="footer-container">
        <div class="container-xxl py-4 border-top border-bottom footer-box">
            <div class="row">
                ...
                <div class="col-3">
                    <div class="contact-and-buy mb-4">
                        <h2 class="title-component-footer mb-3">Hỗ trợ khách hàng</h2>
                        <div class="d-flex flex-column text-black">
                            <a class="d-block mb-2" href="mailto:cskh@itech.com ">
                                <b class="d-block text-black mb-1">Chăm sóc khách hàng</b>
                                cskh@itech.com
                            </a>
                            <a class="d-block" href="mailto:doanhnghiep@itech.com  ">
                                <b class="d-block text-black mb-1">Báo giá danh nghiệp</b>
                                doanhnghiep@itech.com
                            </a>

                        </div>
                    </div>
                    <div class="footer-ul">
                        <h2 class="title-component-footer mb-3">Chích sách bán hàng</h2>
                        <div class="d-flex flex-column text-black">
                            <ul>
                ...
                <div class="col-3">
                    <div class="payment-method-footer mb-4">
                        <h2 class="title-component-footer mb-3">Hình thức thanh toán</h2>
                        <img class="w-75 img-thumbnail" src="{{asset('user/assets/images/footer-payment.png')}}" alt="">
                    </div>
                    <div class="social-footer">
                        <h2 class="title-component-footer mb-3">Liên kết với Itech</h2>
                        <div class="d-flex flex-row gap-2">
                            <a href="#">
                                <img width="32" class="img-fluid rounded-3" src="{{asset('user/assets/images/zalo.png')}}" alt="">
                            </a>
                            <a class="bg-facebook" href="#">
                                <i class="fa-brands fa-facebook-f"></i>
                            </a>
                            <a class="bg-youtube" href="#">
                                <i class="fa-brands fa-youtube"></i>
                            </a>
                            <a class="bg-instagram" href="#">
                                <i class="fa-brands fa-instagram"></i>
                            </a>
                            <a class="bg-tiktok" href="#">
    ...
    <div class="container-xxl text-center mt-3 text-black">
        <p class="mb-1">Công ty TNHH Itechc Mobile - GPĐKKD: 0316579658 do sở KH & ĐT TP. HCM cấp ngày 09/11/2020.</p>
        <p class="mb-1">Địa chỉ: 135/1/8 Nguyễn Hữu Cảnh, Phường 22, Quận Bình Thạnh, Thành phố Hồ Chí Minh, Việt Nam.</p>
        <p class="mb-1">Điện thoại: 1800 3355 - 0838335577</p>
    </div>
</footer>