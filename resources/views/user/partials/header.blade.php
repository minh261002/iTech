        ...
        <div class="container-xxl">
            <div class="row">
                ...
                <div class="col-3 m-auto">
                    <div class="box-search py-2 px-3 border rounded-2">
                        <div class="row">
                            <div class="col-10">
                    ...
                    <div class="row menu-header-box d-flex align-items-center g-0">
                        <div class="col">
                            <a href="#">
                                <div class="row g-0">
                                    ...
                                    <div class="col">
                                        <div class="row my-1">
                                            <h3 class="p-0" style="font-size: 13px; color: var(--secondary);">HOTLINE
                                            </h3>
                                        </div>
                                        <div class="row my-1">
                                            <h3 class="p-0 fw-bold" style="color: var(--primary); font-size:13px;">
                                                19003355</h3>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col ">
                            <a href="#">
                                <div class="row g-0">
                                    ...
                                    <div class="col">
                                        <div class="row my-1">
                                            <h3 class="p-0 fw-bold" style="color: var(--primary); font-size:13px; ">GIỎ
                                                HÀNG</h3>
                                        </div>
                                        <div class="row my-1">
                                            <h3 class="p-0" style="font-size: 13px; color: var(--secondary);">CỦA BẠN
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col ">
                            <a href="">
                                <div class="row g-0">
                                    ...
                                    <div class="col">
                                        <div class="row my-1">
                                            <h3 class="p-0" style="font-size: 13px; color: var(--secondary);">KIỂM
                                                TRA</h3>
                                        </div>
                                        <div class="row my-1">
                                            <h3 class="p-0 fw-bold" style="color: var(--primary); font-size:13px;">ĐƠN
                                                HÀNG</h3>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col ">
                            <a href="">
                                <div class="row g-0">
                                    ...
                                    <div class="col">
                                        <div class="row my-1">
                                            <h3 class="p-0" style="font-size: 13px; color: var(--secondary);">HỆ
                                                THỐNG</h3>
                                        </div>
                                        <div class="row my-1">
                                            <h3 class="p-0 fw-bold" style="color: var(--primary); font-size:13px;">CỬA
                                                HÀNG</h3>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col ">
                            <div class="row g-0">
                                ...
                                <div class="col">
                                    <div class="row my-1">
                                        <h3 class="p-0" style="font-size: 13px; color: var(--secondary);">TÀI KHOẢN
                                        </h3>
                                    </div>
                                    <div class="row my-1">
                                        @if (auth()->guard('web')->check())
                                            <div class="dropdown ps-0">
                                                <div class="dropdown-toggle p-0 fw-bold header_item-custom cursor-pointer"
                                        ...
                                        @else
                                            <a href="{{ route('user.login') }}" class="p-0 fw-bold"
                                                style="color: var(--primary); font-size:13px;">ĐĂNG
                                                NHẬP</a>
                                        @endif
                                    </div>
                                </div>
