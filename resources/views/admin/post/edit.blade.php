...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.post.update') }}" class="row" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea name="content" class="ck-editor" id="ckDescription" {{ isset($disabled) ? 'disabled' : '' }}>{{ $post->content }}</textarea>
                                @error('content')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="seo-preview border p-2 rounded mb-3">
                            ...
                            <div class="seo-preview-description">
                                ...
                                <span class="seo-preview-description-content">
                                    {{ $post->meta_description ? $post->meta_description : 'Mô tả SEO' }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <span class="image img-cover image-target"><img class="w-100"
                                        src="{{ old('image', $post->image ?? '') ? old('image', $post->image ?? '') : asset('admin/assets/images/not-found.jpg') }}"
                                        alt=""></span>
