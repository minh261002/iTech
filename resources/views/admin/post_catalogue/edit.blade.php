                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="meta_title" name="meta_title"
                                value="{{ $post_catalogue->meta_title }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="meta_description" class="form-control" id="meta_description">{{ $post_catalogue->meta_description }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="meta_keywords" name="meta_keywords"
                                value="{{ $post_catalogue->meta_keywords }}">
                            @error('meta_keywords')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
