...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.discount.update', $discount->id) }}" class="row" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h2 class="card-title mb-0">Chỉnh sửa mã giảm giá</h2>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control flatpickr-input active" id="datetime-datepicker"
                                    readonly="readonly" name="date_start" value="{{ $discount->date_start }}">
                                @error('date_start')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control flatpickr-input active" id="datetime-datepicker"
                                    readonly="readonly" name="date_end" value="{{ $discount->date_end }}">
                                @error('date_end')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" name="type" id="type">
                                    <option value="1" {{ $discount->type == 1 ? 'selected' : '' }}>Phần trăm</option>
                                    <option value="2" {{ $discount->type == 2 ? 'selected' : '' }}>Số tiền</option>
                                </select>
                                @error('type')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            @if ($discount->type == 1)
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="percent_value" name="percent_value"
                                        value="{{ $discount->percent_value }}" placeholder="%">
                                    @error('percent_value')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            @if ($discount->type == 2)
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="value">Giá trị</label>
                                    <input type="number" class="form-control" id="discount_value" name="discount_value"
                                        value="{{ $discount->discount_value }}" placeholder="VNĐ">
                                    @error('discount_value')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <select class="form-select" name="status" id="status">
                            <option value="1" {{ $discount->status == 1 ? 'selected' : '' }}>Bản nháp</option>
                            <option value="2" {{ $discount->status == 2 ? 'selected' : '' }}>Đã xuất bản</option>
                        </select>
                    </div>
                </div>
                <div class="card">
